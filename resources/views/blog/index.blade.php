	...
	<div class="form-group row add">
		...
		<div class="col-md-2">
			...
			<button class="btn btn-warning" type="submit" id="add">
				...
				<span class="glyphicon-plus"></span> Add New Data
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal header">
						...
						<button type="button" class="close" data-dismiss="modal" data-target="#m">&times;</button>
					...
					<div class="modal-body item" id="">
						...
						<span id="footer_action_button" class="glyphicon glyphicon-remove"></span>Close
